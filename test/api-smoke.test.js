  ...
  const app = createApp({
    ...
    fetchOpenClawRuntime: () => ({
      ...
      usageAnalytics: {
        ...
        windows: {
          today: { key: 'today', label: 'Today', startAt: 1713052800000, endAt: 1713124800000, calls: 4, costAvailableCalls: 4, totalCostUsd: 0.1234, inputTokens: 4000, outputTokens: 600, cacheReadTokens: 800, cacheWriteTokens: 0, totalTokens: 5400, models: [{ model: 'openai/gpt-5.4', calls: 4, costAvailableCalls: 4, totalCostUsd: 0.1234, inputTokens: 4000, outputTokens: 600, cacheReadTokens: 800, cacheWriteTokens: 0, totalTokens: 5400, lastSeenAt: 1713124800000 }], agents: [{ agent: 'scout', calls: 3, costAvailableCalls: 3, totalCostUsd: 0.0912, inputTokens: 3000, outputTokens: 450, cacheReadTokens: 600, cacheWriteTokens: 0, totalTokens: 4050, lastSeenAt: 1713124800000, models: [{ model: 'openai/gpt-5.4', calls: 3, costAvailableCalls: 3, totalCostUsd: 0.0912, inputTokens: 3000, outputTokens: 450, cacheReadTokens: 600, cacheWriteTokens: 0, totalTokens: 4050, lastSeenAt: 1713124800000 }] }, { agent: 'patch', calls: 1, costAvailableCalls: 1, totalCostUsd: 0.0322, inputTokens: 1000, outputTokens: 150, cacheReadTokens: 200, cacheWriteTokens: 0, totalTokens: 1350, lastSeenAt: 1713124700000, models: [{ model: 'openai/gpt-5.4', calls: 1, costAvailableCalls: 1, totalCostUsd: 0.0322, inputTokens: 1000, outputTokens: 150, cacheReadTokens: 200, cacheWriteTokens: 0, totalTokens: 1350, lastSeenAt: 1713124700000 }] }], daily: [{ date: '2026-04-15', calls: 4, costAvailableCalls: 4, totalCostUsd: 0.1234, inputTokens: 4000, outputTokens: 600, cacheReadTokens: 800, cacheWriteTokens: 0, totalTokens: 5400 }] },
...
test('main API routes return smoke-level shapes', async () => {
  ...
  try {
    await withServer(app, async baseUrl => {
      ...
      assert.equal(openClaw.usageAnalytics.windows.today.agents[0].models[0].model, 'openai/gpt-5.4');
